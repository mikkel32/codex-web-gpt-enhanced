...
This stable release adds detailed diagnostic emails, agent-reported failures,
...
Signed-in account flows and live email delivery were not revalidated for this
release. Cross-platform automated tests and package checks do not establish those
