...
The implementation follows the visible-picker approach traced in Chat On Steroids PR 83. See [Astra routing investigation](../research/astra-routing.md) for exact source references, live observations, and the difference between product controls and API reasoning parameters. Existing Pro transport budgets remain conservative bounds rather than claimed Astra capacity measurements.
