...
const en = {
  ...
  manualInteraction: "Manual (Zero Risk)",
  ...
  webModelsBody: "Choose a ChatGPT Web model in the same picker to use your ChatGPT session. Keep this launcher running while the bridge is connected.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  manualInteraction: "手动（Zero Risk）",
...
const ja: Record<keyof typeof en, string> = {
  ...
  manualInteraction: "手動（Zero Risk）",
