...
const en = {
  ...
  biggerContextBody: "File-based delivery for compatibility workflows. Full-mode task context automatically uses acknowledged retrieval. This setting does not increase model capacity.",
  ...
  setupSubtitle: "Connect your ChatGPT account and add its models to Codex.",
  ...
  automaticInteractionBody: "Maria prepares and sends your prompts, then keeps the browser and tools connected. You approve sign-in and permissions.",
  manualInteraction: "Manual",
  turnReviewTitle: "Review interrupted chat",
  turnReviewBody: "Review the response and any completed actions in this chat. This enables your next message in the original Codex task; it does not resend the interrupted request.",
  turnReviewConfirm: "I reviewed this chat",
  turnReviewChecking: "Checking chat...",
  ...
  manualInteractionBody: "You choose the connector, model and effort, then paste and send each prompt yourself. Requires the Full tool connection; Maria does not read ChatGPT.",
  optional: "Optional",
  required: "Required",
  stepAccount: "Sign in to ChatGPT",
  stepAccountBody: "Connect your existing browser session or sign in directly to ChatGPT.",
  signIn: "Open sign in",
  ...
  stepInstallBody: "Check the models available to your account and add them to the Codex model picker.",
  ...
  mcpSubtitle: "Give ChatGPT access to the files and tools in your Codex workspace.",
  ...
  mcpStepOne: "Need connection credentials?",
  toolCredentialsFormat: "Paste the complete Tunnel ID (tunnel_ followed by 32 lowercase hexadecimal characters) and the full restricted key. The Connect button becomes available when both are complete.",
  mcpStepOneBody: "Create a tunnel in the workspace you use in ChatGPT. Create a restricted key with only Tunnels Read and Use permissions. Use a separate tunnel for each Maria installation; do not share it with another computer or Codex's native MCP server.",
  openTunnels: "Open Tunnels",
  openKeys: "Create API key",
  mcpStepTwo: "Connect this computer",
  mcpStepTwoBody: "Add your connection details once. Maria installs the local components, checks the connection, and keeps your key in private local storage—not in logs.",
  ...
  settingsTitle: "Make Maria yours",
  general: "General",
  ...
  loading: "Loading",
  restoreBrowserView: "Restore view",
  restoreBrowserViewBody: "Restore the page view without reloading or interrupting the task.",
  platform: "Platform",
  version: "Version",
  status: "Status",
...
const zh: Record<keyof typeof en, string> = {
  ...
  biggerContextBody: "兼容工作流使用文件传输。Full 模式会自动使用带确认回执的上下文检索。此设置不会增加模型容量。",
  ...
  setupSubtitle: "连接 ChatGPT 账户，将模型添加到 Codex。",
  coreSetup: "核心设置",
  ...
  automaticInteractionBody: "Maria 准备并发送提示词，保持浏览器和工具连接。登录与权限由你批准。",
  manualInteraction: "手动",
  turnReviewTitle: "检查中断的聊天",
  turnReviewBody: "请检查此聊天中的回复及已完成的操作。确认后可在原 Codex 任务中发送下一条消息；不会重发中断的请求。",
  turnReviewConfirm: "我已检查此聊天",
  turnReviewChecking: "正在检查聊天…",
  ...
  manualInteractionBody: "自行选择连接器、模型和 effort，再粘贴并发送每条提示。需要 Full 工具连接；Maria 不读取 ChatGPT。",
  optional: "可选",
  required: "必需",
  ...
  mcpSubtitle: "让 ChatGPT 使用 Codex 工作区中的文件与工具。",
  ...
  mcpStepOne: "需要连接凭据？",
  toolCredentialsFormat: "粘贴完整 Tunnel ID（tunnel_ 后接 32 位小写十六进制字符）和完整受限密钥。两项完整后即可连接。",
  mcpStepOneBody: "在 ChatGPT 所用工作区创建隧道。创建仅有 Tunnels Read 和 Use 权限的受限密钥。为此 Maria 安装使用专属连接。",
  openTunnels: "打开 Tunnels",
  openKeys: "创建 API key",
  mcpStepTwo: "连接此计算机",
  mcpStepTwoBody: "只需添加一次连接信息。Maria 安装本地组件并检查连接，密钥仅保存在本机私有存储中，不会写入日志。",
  ...
  needsAttention: "需要处理",
  loading: "加载中",
  restoreBrowserView: "恢复显示",
  restoreBrowserViewBody: "恢复页面显示，不重新加载或中断任务。",
  platform: "平台",
  version: "版本",
  status: "状态",
  notConfigured: "未配置",
...
const ja: Record<keyof typeof en, string> = {
  ...
  biggerContextBody: "互換ワークフロー向けのファイル転送です。Full モードは受信確認付きのコンテキスト取得を自動で使います。モデルの容量は増えません。",
  ...
  setupSubtitle: "ChatGPT アカウントを接続し、モデルを Codex に追加します。",
  coreSetup: "基本セットアップ",
  ...
  automaticInteractionBody: "Maria がプロンプトを準備・送信し、ブラウザーとツールの接続を保ちます。ログインと権限は自分で確認します。",
  manualInteraction: "手動",
  turnReviewTitle: "中断したチャットを確認",
  turnReviewBody: "このチャットの応答と完了した操作を確認してください。確認後は元の Codex タスクで次のメッセージを送信できます。中断したリクエストの再送は行いません。",
  turnReviewConfirm: "このチャットを確認しました",
  turnReviewChecking: "チャットを確認中…",
  ...
  manualInteractionBody: "コネクタ、モデル、effort を選び、各プロンプトを自分で貼り付けて送信します。Full ツール接続が必要です。Maria は ChatGPT を読み取りません。",
  optional: "任意",
  required: "必須",
  ...
  mcpSubtitle: "ChatGPT が Codex ワークスペースのファイルとツールを利用できるようにします。",
  ...
  mcpStepOne: "接続用の認証情報が必要ですか？",
  toolCredentialsFormat: "完全な Tunnel ID（tunnel_ と小文字の 16 進数 32 桁）および制限付きキーを貼り付けてください。両方が揃うと接続できます。",
  mcpStepOneBody: "ChatGPT と同じワークスペースにトンネルを作成します。Tunnels Read と Use のみの制限付きキーを作成し、この Maria インストール専用の接続を使用してください。",
  openTunnels: "Tunnels を開く",
  openKeys: "API キーを作成",
  mcpStepTwo: "このコンピューターを接続",
  mcpStepTwoBody: "接続情報の登録は一度だけです。Maria がローカルコンポーネントをインストールし、接続を確認します。キーは非公開のローカルストレージに保存され、ログには記録されません。",
  ...
  loading: "読み込み中",
  restoreBrowserView: "表示を復元",
  restoreBrowserViewBody: "再読み込みやタスクの中断をせずにページ表示を復元します。",
  platform: "プラットフォーム",
  version: "バージョン",
  status: "ステータス",
  notConfigured: "未設定",
