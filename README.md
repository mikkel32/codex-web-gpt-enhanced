> Enhanced fork of [miuuyy/codex-chatgpt-web](https://github.com/miuuyy/codex-chatgpt-web), based on the revision in `UPSTREAM.lock`. See [enhanced release notes](docs/enhanced-release.md) for model coexistence, manual mode, validation, and private-repository installation.
...
<p align="center">
  <a href="https://github.com/mikkel32/codex-web-gpt-enhanced/actions/workflows/ci.yml"><img src="https://github.com/mikkel32/codex-web-gpt-enhanced/actions/workflows/ci.yml/badge.svg" alt="CI"></a>
...
```bash
curl -fsSL https://github.com/mikkel32/codex-web-gpt-enhanced/releases/latest/download/install-launcher.sh | sh
```

**Windows PowerShell**

```powershell
irm https://github.com/mikkel32/codex-web-gpt-enhanced/releases/latest/download/install-launcher.ps1 | iex
```
...
keeps browser interaction under your control. In this fork the picker calls it **Manual**;
the existing `Codex Zero Risk` connector name is unchanged. Prepare and confirm within five
minutes; the connector then has 90 seconds to start.
